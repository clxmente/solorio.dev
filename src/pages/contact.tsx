        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="col-span-2 flex flex-col space-y-3 md:col-span-1">
            ...
            <Social
              ...
              hover="group-hover:text-[#745C97]"
              _icon={EnvelopeIcon}
            />
          </div>

          <form className="col-span-2 space-y-3 rounded-md border border-white/20 bg-[#1b2535] p-5 backdrop-blur-sm">
            {/* Email */}
            ...
            <div className="flex justify-end">
              <button className="flex items-center space-x-3 rounded-full bg-[#39375B] py-2 px-4 transition-transform hover:scale-95">
